export const LoaderConfig = {
    ...
    heartSkipBlack1 : require("../sprites/New/heartSkipBlack1.png"),
    ...
    resultCloseBtn : require("../sprites/New/resultCloseBtn.png"),
    ...
    //confirm action
    promptBox : require("../sprites/confirmAction/promptbox.png"),
    promptBg : require("../sprites/confirmAction/promptbg.png"),
    yesBtn : require("../sprites/confirmAction/yes.png"),
    noBtn : require("../sprites/confirmAction/no.png"),
    leaveBtn : require("../sprites/confirmAction/leave.png"),

    //disconnect
    wifi : require("../sprites/wifi.png"),
    playerLeft : require("../sprites/left.png"),
...
export const LoaderSoundConfig = {
    ...
    tick : require("../sounds/Timetick.mp3"),
};
